...
[说到图表](https://css-tricks.com/css-bar-charts-using-modern-functions/)……你上一次使用饼图是什么时候？如果你经常做演示，那你大概很熟悉它。作者说，这几乎是他的“个人地狱”；他本以为自己已经很久不用饼图了，直到最近。

去年，他为墨西哥一个儿童慈善机构做网站。流程本身很常规，但对方希望在落地页上用饼图展示数据。由于时间紧张，他直接用了一个现成的[JavaScript 图表库](https://css-tricks.com/the-many-ways-of-getting-data-into-charts/)。

效果看起来没问题，但他始终觉得不太舒服：为了几个简单饼图引入一整套库，更像权宜之计，而不是理想解法。

所以他想补上这件事。本文会尝试用 CSS 做出“尽可能完美”的饼图：在解决手写饼图常见痛点的同时，把 JavaScript 压到最低。开始前，先定义“完美”的目标。
