...
Published 06 Feb, 2026 under [Release Notes](https://eslint.org/blog/category/release-notes)
...
As there are a lot of changes, we’ve created a [migration guide](https://eslint.org/docs/latest/use/migrate-to-10.0.0) describing the breaking changes in great detail along with the steps you should take to address them. We expect that most users should be able to upgrade without any build changes, but the migration guide should be a useful resource if you encounter problems.
...
As [announced in Flat config rollout plans](https://eslint.org/blog/2023/10/flat-config-rollout-plans/#eslintrc-removed-in-eslint-v10.0.0), the eslintrc config system has been completely removed in ESLint v10.0.0. Specifically, this means:
...
- **False positives**: `<Card>` could be reported as “defined but never used” ([`no-unused-vars`](https://eslint.org/docs/latest/rules/no-unused-vars)).

- **False negatives**: Removing the import might not trigger an “undefined variable” error ([`no-undef`](https://eslint.org/docs/latest/rules/no-undef)).
...
The [`RuleTester#run()`](https://eslint.org/docs/latest/integrate/nodejs-api#ruletesterrun) method now supports **assertion options**, specifically `requireMessage`, `requireLocation`, and `requireData`, to let developers enforce stricter requirements in rule tests. These options enforce that every invalid test case explicitly checks violation messages, locations, and data, ensuring that a test fails if it doesn’t meet the requirements.
...
When the [`--color` or `--no-color`](https://eslint.org/docs/next/use/command-line-interface#--color-and---no-color) option is specified on the command line, ESLint sets an additional `color` property on the context object passed to a formatter (the second argument of the `format()` method). This property is `true` for `--color` and `false` for `--no-color`. [Custom formatters](https://eslint.org/docs/next/extend/custom-formatters) can use this value to determine whether to apply color styling, based on the assumption that the terminal supports or does not support colors as indicated by the option.
...
The following [`SourceCode`](https://eslint.org/docs/next/extend/custom-rules#accessing-the-source-code) methods are no longer available:
...
- [`a2ee188`](https://github.com/eslint/eslint/commit/a2ee188ea7a38a0c6155f3d39e2b00e1d0f36e14) fix!: add `uniqueItems: true` in [`no-invalid-regexp`](https://eslint.org/docs/rules/no-invalid-regexp) option ([#20155](https://github.com/eslint/eslint/issues/20155)) (Tanuj Kanti)
...
- [`f28fbf8`](https://github.com/eslint/eslint/commit/f28fbf846244e043c92b355b224d121b06140b44) fix!: Deprecate `"always"` and `"as-needed"` options of the [`radix`](https://eslint.org/docs/rules/radix) rule ([#20223](https://github.com/eslint/eslint/issues/20223)) (Milos Djermanovic)

- [`aa3fb2b`](https://github.com/eslint/eslint/commit/aa3fb2b233e929b37220be940575f42c280e0b98) fix!: tighten [`func-names`](https://eslint.org/docs/rules/func-names) schema ([#20119](https://github.com/eslint/eslint/issues/20119)) (Pixel998)
...
- [`f18115c`](https://github.com/eslint/eslint/commit/f18115c363a4ac7671a4c7f30ee13d57ebba330f) feat!: [`no-shadow-restricted-names`](https://eslint.org/docs/rules/no-shadow-restricted-names) report `globalThis` by default ([#20027](https://github.com/eslint/eslint/issues/20027)) (sethamus)
...
- [`bff9091`](https://github.com/eslint/eslint/commit/bff9091927811497dbf066b0e3b85ecb37d43822) feat: handle `Array.fromAsync` in [`array-callback-return`](https://eslint.org/docs/rules/array-callback-return) ([#20457](https://github.com/eslint/eslint/issues/20457)) (Francesco Trotta)

- [`290c594`](https://github.com/eslint/eslint/commit/290c594bb50c439fb71bc75521ee5360daa8c222) feat: add `self` to [`no-implied-eval`](https://eslint.org/docs/rules/no-implied-eval) rule ([#20468](https://github.com/eslint/eslint/issues/20468)) (sethamus)

- [`43677de`](https://github.com/eslint/eslint/commit/43677de07ebd6e14bfac40a46ad749ba783c45f2) feat: fix handling of function and class expression names in [`no-shadow`](https://eslint.org/docs/rules/no-shadow) ([#20432](https://github.com/eslint/eslint/issues/20432)) (Milos Djermanovic)
...
- [`7cbcbf9`](https://github.com/eslint/eslint/commit/7cbcbf9c3c2008deee7d143ae35e668e8ffbccb3) feat: add `countThis` option to [`max-params`](https://eslint.org/docs/rules/max-params) ([#20236](https://github.com/eslint/eslint/issues/20236)) (Gerkin)
...
- [`09e6654`](https://github.com/eslint/eslint/commit/09e66549ecada6dcb8c567a60faf044fce049188) feat: update error loc of [`require-yield`](https://eslint.org/docs/rules/require-yield) and [`no-useless-constructor`](https://eslint.org/docs/rules/no-useless-constructor) ([#20267](https://github.com/eslint/eslint/issues/20267)) (Tanuj Kanti)
...
- [`727451e`](https://github.com/eslint/eslint/commit/727451eff55b35d853e0e443d0de58f4550762bf) fix: fix regression of global mode report range in [`strict`](https://eslint.org/docs/rules/strict) rule ([#20462](https://github.com/eslint/eslint/issues/20462)) (ntnyq)
...
- [`53e9522`](https://github.com/eslint/eslint/commit/53e95222af8561a8eed282fa9fd44b2f320a3c37) fix: [strict](https://eslint.org/docs/rules/strict) removed formatters check ([#20241](https://github.com/eslint/eslint/issues/20241)) (ntnyq)
...
- [`b0e4717`](https://github.com/eslint/eslint/commit/b0e4717d6619ffd02913cf3633b44d8e6953d938) docs: [[no-await-in-loop](https://eslint.org/docs/rules/no-await-in-loop)] Expand inapplicability ([#20363](https://github.com/eslint/eslint/issues/20363)) (Niklas Hambüchen)
...
- [`d925c54`](https://github.com/eslint/eslint/commit/d925c54f045b2230d3404e8aa18f4e2860a35e1d) docs: update config syntax in [`no-lone-blocks`](https://eslint.org/docs/rules/no-lone-blocks) ([#20413](https://github.com/eslint/eslint/issues/20413)) (Pixel998)
...
- [`5a4324f`](https://github.com/eslint/eslint/commit/5a4324f38e7ce370038351ef7412dcf8548c105e) docs: clarify `"local"` option of [`no-unused-vars`](https://eslint.org/docs/rules/no-unused-vars) ([#20385](https://github.com/eslint/eslint/issues/20385)) (Milos Djermanovic)
...
- [`0f5a94a`](https://github.com/eslint/eslint/commit/0f5a94a84beee19f376025c74f703f275d52c94b) docs: [[class-methods-use-this](https://eslint.org/docs/rules/class-methods-use-this)] explain purpose of rule ([#20008](https://github.com/eslint/eslint/issues/20008)) (Kirk Waiblinger)
...
- [`adf7a2b`](https://github.com/eslint/eslint/commit/adf7a2b202743a98edc454890574292dd2b34837) docs: [no-unsafe-finally](https://eslint.org/docs/rules/no-unsafe-finally) note for generator functions ([#20330](https://github.com/eslint/eslint/issues/20330)) (Tom Pereira)
...
- [`6742f92`](https://github.com/eslint/eslint/commit/6742f927ba6afb1bce6f64b9b072a1a11dbf53c4) test: add endLine/endColumn to invalid test case in [no-alert](https://eslint.org/docs/rules/no-alert) ([#20441](https://github.com/eslint/eslint/issues/20441)) (경하)

- [`3e22c82`](https://github.com/eslint/eslint/commit/3e22c82a87f44f7407ff75b17b26f1ceed3edd14) test: add missing location data to [no-template-curly-in-string](https://eslint.org/docs/rules/no-template-curly-in-string) tests ([#20440](https://github.com/eslint/eslint/issues/20440)) (Haeun Kim)
...
- [`ba71baa`](https://github.com/eslint/eslint/commit/ba71baa87265888b582f314163df1d727441e2f1) test: enable [`strict`](https://eslint.org/docs/rules/strict) mode in type tests ([#20398](https://github.com/eslint/eslint/issues/20398)) (루밀LuMir)
...
- [`796ddf6`](https://github.com/eslint/eslint/commit/796ddf6db5c8fe3e098aa3198128f8ce3c58f8e0) chore: update dependency @eslint/js to ^9.39.1 ([#20285](https://github.com/eslint/eslint/issues/20285)) (renovate[bot])
        ...
        ![](https://avatars.githubusercontent.com/u/38546)
