原文：[Is it scrolled? Is it not? Let's find out with CSS @container scroll-state() queries](https://utilitybend.com/blog/is-it-scrolled-is-it-not-lets-find-out-with-css-container-scroll-state-queries)
翻译：TUARAN
