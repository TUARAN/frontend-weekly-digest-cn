---
title: 每日精选 · 2026年07月13日
slug: ai-daily-20260713
date: 2026-07-13
category: 每日精选
tldr: 今日精选 5 条 AI 动态：Ploy 将 AI 智能体默认…、腾讯混元发布Hy3模型：295…、Mindwalk：在代码库 3…、OpenAI CEO Altm…、Tibo 分享通过 CLIPr…
readMinutes: 3
pro: false
tags:
  - AI Coding
...
### 2. 腾讯混元发布Hy3模型：295B参数MoE架构，Agent向LLM定位，已集成微信服务10亿+用户
...
### 3. Mindwalk：在代码库 3D 地图上回放编码代理会话
...
### 4. OpenAI CEO Altman 改口称 AI 净创造就业，Anthropic CEO 也修正早期言论
...
[阅读原文](https://the-decoder.com/openai-ceo-altman-is-now-pretty-sure-ai-is-net-job-creating-which-is-quite-the-pivot-from-predicting-mass-layoffs)

---

### 5. Tibo 分享通过 CLIProxyAPI 将 Claude Code 后端模型切换为 GPT-5.6 Sol 的方法
...
[阅读原文](https://x.com/thsottiaux/status/2076119366647894371)
